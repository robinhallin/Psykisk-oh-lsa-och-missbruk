// V6: samtliga moduler omarbetade på djupet. Innehållet bygger på de uppladdade kursfilerna.
(() => {
...
// V6-fördjupning: rikare lektionstext, aktiv återkallning och fler frågor i samtliga moduler.
(() => {
  const D = window.STUDY_DATA;
  ...
  Object.assign(M('suicidrisk'), {
    ...
    sections:[
      ...
      {h:'10. Källgräns – vad denna modul inte ersätter',p:'Studiehandledningen anger en separat suicidologiföreläsning och webbutbildningen SPiSS del I–II. De materialen finns inte bland projektfilerna. V6-modulen är därför en fördjupad syntes av de tillgängliga kurskällorna, men ska inte betraktas som ersättning för hela kursens suicidologidel.',warning:'Komplettera denna modul med SPiSS och den separata suicidologiföreläsningen i Canvas när du har tillgång till dem.'}
    ],
  ...
  mergeLesson('suicidrisk',{
    sourceNote:'Den separata suicidologiföreläsningen och SPiSS finns inte bland projektfilerna. V6 använder därför POLKON-stödmaterialet, affektiva syndrom, psykos, LPT, kommunikationsmaterialet och studiehandledningen.',
    quickChecks:[
  ...
  // Säkerställ minst tio unika slutfrågor i de moduler där V6-materialet annars gav nio.
...
// V6: tentamensinspiration + träningslabb. Frågorna är omarbetade från den uppladdade tentamen 2025.
(() => {
  const D = window.STUDY_DATA;
  const src = 'Tentamen D2PM2U 2025 (omarbetad)';
  const Q = (examNo,moduleId,topic,goal,q,a,c,e) => ({examNo,moduleId,topic,goal,q,a,c,e,source:src,origin:'exam2025'});
  D.examInspired = [
    Q(1,'beroende','Beroende','1.1','Vilka två påståenden om beroende och abstinens stämmer bäst enligt tentamensmaterialet?',[
      'Opioidberoende ger generellt få utsättningsproblem eftersom opioider lagras i fettväv.',
      'Vid opioidberoende kan fortsatt bruk drivas av att undvika värk, svettningar, illamående och diarré.',
      'Cannabis är ett ofarligt preparat som alltid kräver medicinsk avgiftning.',
      'All abstinens måste alltid behandlas inneliggande på sjukhus.',
      'Långvarigt bensodiazepinberoende kan kräva långsam nedtrappning på grund av besvärlig abstinens.'
    ],[1,4],'Negativ förstärkning kan upprätthålla opioidbruk. Bensodiazepinabstinens kan vara uttalad och nedtrappning kan behöva ske långsamt.'),
    Q(2,'beroende','Beroende','2.3','Vilket påstående om samsjuklighet och beroende ligger närmast tentamensmaterialet?',[
      'Bipolär sjukdom, antisocial problematik och ADHD kan förekomma tillsammans med beroende; impulsivitet och konsekvenstänk kan vara relevanta faktorer.',
      'Hälso- och sjukvården har ensamansvar för all beroendeproblematik i samhället.',
      'Psykiatrisk samsjuklighet är ovanlig vid beroende.',
      'Beroende är ett invant beteende som lätt bryts om motivationen är tillräcklig.',
      'Toleransutveckling saknar betydelse vid beroendeutveckling.'
    ],0,'Tentamen betonar att beroende ofta behöver förstås tillsammans med psykisk ohälsa och andra sårbarhetsfaktorer.'),
    Q(3,'beroende','Beroende','2.3','Vilka tre samhälls- eller individkonsekvenser av beroende stämmer med tentamensmaterialet?',[
      'Droger förekommer sällan i samband med brott.',
      'Anhöriga påverkas sällan psykiskt av en närståendes beroende.',
      'Familjemedlemmar kan själva utveckla psykisk ohälsa.',
      'Omfattande cannabisbruk är associerat med sämre sociala utfall som lägre inkomst och högre arbetslöshet.',
      'Kvinnor som injicerar narkotika kan ha särskilt hög utsatthet för våld och övergrepp.'
    ],[2,3,4],'Beroendeproblematik kan ge omfattande konsekvenser för både den enskilde, närstående och samhället.'),
    Q(4,'beroende','Beroende','2.3','Vilka två påståenden om sociala konsekvenser stämmer bäst?',[
      'Förekomsten av droger är likvärdig i alla sociala miljöer.',
      'Föräldrar kan utsättas för brott, hot eller ekonomiska påtryckningar kopplade till ett barns narkotikaproblem.',
      'Kvinnor och män har alltid samma utsatthet i narkotikamiljöer.',
      'Cannabisanvändning är vanligare bland ungdomar med familjemässiga, sociala eller psykologiska problem.',
      'En kriminell livsstil innebär typiskt många stabila legala karriärvägar att falla tillbaka på.'
    ],[1,3],'Tentamen lyfter både anhörigutsatthet och sambandet mellan ungdomars cannabisbruk och annan social/psykologisk problematik.'),

    Q(5,'lpt','LPT','1.2','Vilka tre kärnrekvisit ska du kunna identifiera för sluten psykiatrisk tvångsvård enligt LPT 3 §?',[
      'Personen måste redan ha ett öppet LPT.',
      'Ett oundgängligt behov av kvalificerad psykiatrisk dygnetruntvård som inte kan tillgodoses på annat sätt.',
      'Allvarlig psykisk störning.',
      'Patienten motsätter sig vården eller samtycke kan inte tillförlitligt erhållas på grund av tillståndet.',
      'Personen måste alltid vara direkt farlig för sig själv.',
      'Personen måste alltid tidigare ha skadat någon annan.'
    ],[1,2,3],'Farlighet kan vägas in i vårdbehovet men är inte ett självständigt obligatoriskt rekvisit i varje fall. Kärnan är APS, oundgängligt vårdbehov och bristande samtycke.'),
    Q(19,'handrackning','Handräckning','2.2','En patrull har handräckning för att föra Brita till vårdinrättning så att läkare kan genomföra vårdintygsundersökning. Personalen säger att läkaren dröjer. Vilket alternativ överensstämmer med tentamensfacit?',[
      'Patrullen lämnar alltid direkt när dörren till avdelningen passerats.',
      'Patrullen stannar bara om chefsöverläkaren muntligen beordrar det.',
      'Patrullen stannar enbart som allmänt trygghetsskapande resurs.',
      'Handräckningsuppdraget fullgörs först när läkaren har kunnat genomföra den undersökning som handräckningen avser.'
    ],3,'Tentamensfacit markerar att polisen i den beskrivna situationen ska stanna tills vårdintygsundersökningen är utförd.'),
    Q(20,'lpt','LPT','2.2','En person står på utsidan av ett broräcke. Det finns skälig anledning att anta APS och fara för eget liv. Vilka två påståenden är korrekta enligt kursens juridik?',[
      'Polisen måste invänta vårdintyg innan någon åtgärd får vidtas.',
      'Vid fara i dröjsmål kan en enskild polisman omhänderta i avvaktan på Polismyndighetens beslut, om förutsättningarna i PL 11 § är uppfyllda.',
      'Polismyndigheten kan besluta om tillfälligt omhändertagande enligt LPT 47 § första stycket.',
      'Polisen måste invänta ambulans eftersom situationen gäller vård.'
    ],[1,2],'Kursmaterialet kopplar LPT 47 § till Polismyndighetens beslut och PL 11 § till fara i dröjsmål.'),

    Q(7,'npf','NPF','2.4','Vilka två anpassningar är särskilt lämpliga i ett polisförhörande samtal med en person med ADHD enligt tentamensmaterialet?',[
      'Håll frågor korta eftersom långa frågor kan belasta arbetsminnet och göra att personen tappar tråden.',
      'Ge flera instruktioner samtidigt så personen inte hinner bli uttråkad.',
      'Utgå från att känsloreglering aldrig är ett problem.',
      'Minska störande intryck och låt helst en person tala åt gången.',
      'Utgå från att ADHD oftast innebär intellektuell funktionsnedsättning.'
    ],[0,3],'Korta frågor, en sak i taget och minskat brus ligger i linje med både NPF-materialet och tentamen.'),
    Q(8,'npf','NPF','1.1','Vilka tre kärnsymtom kännetecknar ADHD i kursmaterialet?',[
      'Hyperaktivitet','Stereotypa och upprepade beteenden','Svårt att visa känslor','Ouppmärksamhet/koncentrationssvårigheter','Impulsivitet','Svårigheter med social interaktion'
    ],[0,3,4],'ADHD:s tre kärnsymtom anges som ouppmärksamhet, hyperaktivitet och impulsivitet.'),

    Q(9,'personlighet','Personlighet','1.1','Vilket påstående om emotionellt instabilt personlighetssyndrom stämmer bäst?',[
      'Alla personer med tillståndet har självskadebeteende.',
      'Rädsla för att bli övergiven och tomhetskänslor kan vara framträdande.',
      'Tillståndet uppstår generellt som en komplikation av långvarigt narkotikabruk.',
      'Tillståndet definieras av långa maniska episoder med minskat sömnbehov.'
    ],1,'Tentamensfrågan skiljer emotionell instabilitet från mani och betonar bland annat rädsla för övergivenhet och tomhetskänslor.'),
    Q(10,'personlighet','Personlighet','2.4','Vilket påstående är mest användbart i polisiärt möte med emotionellt instabil personlighetsproblematik?',[
      'Tillståndet är vanligare hos män och underdiagnostiseras hos kvinnor.',
      'Personen blir regelmässigt psykotisk.',
      'Starka känsloyttringar och återkommande emotionella kriser kan förekomma.',
      'Tillståndet innebär generellt behov av sluten psykiatrisk vård.'
    ],2,'Starka affekter och kriser kan förekomma; bemötande och aktuell risk ska bedömas i situationen.'),

    Q(11,'affektiva','Affektiva','1.1','Vilket alternativ beskriver bipolär sjukdom och mani bäst?',[
      'Humöret växlar typiskt från timme till timme och tillståndet saknar längre episoder.',
      'Sjukdomen innebär längre episoder av förhöjt eller sänkt stämningsläge; mani kan ge minskat sömnbehov, stark energi och många projekt.',
      'Cannabis är den obligatoriska utlösande faktorn.',
      'Personer i mani söker vanligtvis själva hjälp tidigt eftersom de upplever sömnbristen som ett problem.'
    ],1,'Affektiva syndrom handlar om episoder i stämningsläge. Mani kännetecknas bland annat av minskat sömnbehov, energi, tempo och projekt.'),
    Q(12,'affektiva','Affektiva','1.1','Vilka tre symtom är typiska vid depression enligt kursmaterialet?',[
      'Förändrat sömnmönster','Nedstämdhet','Normal sorg efter närståendes död är i sig ett depressionskriterium','Minskat intresse eller glädje','Snabba relationssvängningar är ett obligatoriskt kriterium'
    ],[0,1,3],'Sömnförändring, nedstämdhet och minskat intresse/glädje finns bland de centrala depressionssymtomen.'),

    Q(13,'psykos','Psykos','1.1','Vilka tre observationer kan passa in i en psykotisk/schizofren symtombild?',[
      'Tillbakadragenhet och glädjelöshet','Upplevelse av implantat i kroppen som del av övervakning','Minskat sömnbehov och mängder av projekt','Höra röster som kommenterar personens handlingar','Snabba humörsvängningar från timme till timme som enda fynd'
    ],[0,1,3],'Frågan kombinerar negativa symtom, vanföreställningsliknande innehåll och hörselhallucinationer.'),
    Q(14,'psykos','Psykos','1.1','Vilket påstående om schizofreni stämmer bäst enligt tentamensmaterialet?',[
      'Personer med psykossjukdom är generellt våldsamma.',
      'Schizofreni kan gå i skov och med rätt behandling och gynnsamma psykosociala förhållanden kan funktionsnivån vara god mellan skoven.',
      'Problemlösning, minne och stresstålighet är generellt opåverkade.',
      'Psykoser är alltid drogutlösta.'
    ],1,'Tentamen betonar att schizofreni inte är liktydigt med ständig psykos eller våld och att funktionsnivå kan variera över tid.'),
    Q(15,'psykos','Psykos','1.1','Vilka två påståenden beskriver möjliga förlopp vid schizofreni?',[
      'En person kan leva med vissa kvarvarande psykotiska symtom som upplevs hanterbara.',
      'En person kan vara symtomfri mellan psykotiska skov.',
      'Alla med schizofreni saknar alltid sjukdomsinsikt.',
      'Alla med schizofreni måste tvångsmedicineras.'
    ],[0,1],'Förloppet varierar; både residualsymtom och symtomfria perioder kan förekomma.'),

    Q(16,'suicidrisk','Affektiva','2.4','Vilka tre faktorer markerades som statistiska riskfaktorer för suicid i tentamen?',[
      'Försämrad ekonomi','Suicid i familjen saknar all betydelse','Manligt kön','Tidigare suicidförsök'
    ],[0,2,3],'Tentamen lyfter försämrad ekonomi, manligt kön och tidigare suicidförsök som riskfaktorer.'),
    Q(17,'suicidrisk','Affektiva','2.4','Vilka två påståenden om suicid stämmer med tentamensmaterialet?',[
      'Den som talar om suicid genomför det nästan aldrig.',
      'Beroendeproblematik medför ingen ökad suicidrisk.',
      'Psykisk sjukdom som depression och schizofreni är kopplad till högre suicidrisk.',
      'Kvinnor genomför fler suicidförsök än män.'
    ],[2,3],'Tentamen markerar psykisk sjukdom som riskfaktor och att kvinnor gör fler suicidförsök.'),

    Q(18,'handrackning','Handräckning','1.2','Socialnämnden begär handräckning enligt LVM 45 §. Vilka två principer är korrekta enligt tentamen?',[
      'Handräckning ska inte ske slentrianmässigt; behov av polisens särskilda befogenheter ska bedömas.',
      'Polisen kan alltid neka en lagligen grundad handräckning med hänvisning till resursbrist.',
      'Polisen kan inte neka en behörig handräckning enbart med hänvisning till resursbrist.',
      'Patrullen kan avbryta uppdraget så fort personen verkar samarbetsvillig.'
    ],[0,2],'Handräckningsmaterialet betonar både behovsprövning och skyldigheten att hjälpa när lagens kriterier och behörig begäran finns.'),

    Q(21,'drogtecken','Beroende','2.1','Vilka fyra preparatfakta stämmer enligt tentamensmaterialet?',[
      'Amfetamin luktar oftast ingenting.',
      'Kat är en färskvara och tuggas ofta.',
      'Kokain injiceras typiskt eftersom preparatet främst lämpar sig för det.',
      'Metamfetamin kan förekomma i kristallform.',
      'Kat består typiskt av torkade växtdelar som röks i pipa.',
      'Kokain intas ofta genom att snortas via näsan.',
      'Kokain har alltid en tydlig tvättmedelslukt.',
      'Amfetamin kan ha en utmärkande tvättmedelsliknande doft.'
    ],[1,3,5,7],'Detta är en tentamensnära preparatkännedomfråga: kat, metamfetamin, kokain och amfetamin.'),
    Q(22,'drogtecken','Beroende','2.1','Vilka två påståenden om cannabis stämmer enligt tentamensmaterialet?',[
      'Marijuana, hasch och cannabisextrakt framställs från Cannabis sativa.',
      'Den rusgivande substansen förkortas THC; tentamen anger att växtdelar ovan jord, med undantag för frön, omfattas av narkotikaklassningen.',
      'Alla delar av växten är rusgivande i samma grad.',
      'Cannabis är vattenlösligt och injiceras typiskt.'
    ],[0,1],'Tentamen testar både preparatformer och THC/klassningskunskap.'),
    Q(23,'drogtecken','Beroende','2.1','Vilket preparat kopplas typiskt till fnittrighet och omotiverade skrattattacker i tentamen?',[
      'Amfetamin','Heroin','Cannabis','Kokain'
    ],2,'Fnittrighet och omotiverade skratt kopplas i frågan till cannabis.'),
    Q(23,'drogtecken','Beroende','2.1','Vilket preparat kopplas typiskt till små pupiller?',[
      'Amfetamin','Heroin','Cannabis','Kokain'
    ],1,'Små pupiller är ett klassiskt opiat/opioidmönster och kopplas här till heroin.'),
    Q(23,'drogtecken','Beroende','2.1','Vilket preparat kopplas i tentamen till ökat självförtroende?',[
      'Amfetamin','Heroin','Cannabis','Kokain'
    ],3,'I matchningsfrågan kopplas ökat självförtroende till kokain.'),
    Q(23,'drogtecken','Beroende','2.1','Vilket preparat kopplas i tentamen till darrningar/muskelryckningar och spänd käkmuskulatur?',[
      'Amfetamin','Heroin','Cannabis','Kokain'
    ],0,'Centralstimulantiapåverkan kan ge motorisk spänning, darrningar och käkspänning.'),
    Q(24,'drogtecken','Beroende','2.1','Vilka två preparat utvinns direkt från Cannabis sativa?',[
      'LSD','Hasch','Spice','Fentanyl','Marijuana'
    ],[1,4],'Hasch och marijuana kommer från cannabisväxten. Spice är syntetiska cannabinoider, inte ett växtutvunnet cannabispreparat.'),
    Q(25,'drogtecken','Beroende','2.1','Vilka fyra påståenden stämmer enligt tentamensmaterialet?',[
      'Bensodiazepiner tillhör centraldepressiva medel.',
      'Vitt heroin injiceras ofta.',
      'Kokain tillverkas huvudsakligen i öststaterna.',
      'Opium är torkad växtsaft från opiumvallmon.',
      'Fentanyl är en mycket stark syntetisk opioid som bland annat förekommer i läkemedelsformer som plåster och nässpray.',
      'All cannabis i Sverige är importerad.'
    ],[0,1,3,4],'Frågan blandar drogkategori, ursprung och beredningsformer.'),
    Q(27,'drogtecken','Beroende','2.1','Vilket alternativ är ett typiskt cannabistecken i tentamen?',[
      'Omotiverad lyckokänsla med skrattanfall','Yviga rörelser','Rastlöst uppträdande','Ihopsjunken hållning och långsamma reflexer','Små pupiller'
    ],0,'Cannabis kan ge fnittrighet och omotiverade skrattattacker.'),
    Q(28,'drogtecken','Beroende','2.1','Vilka två påståenden om opiater/opioider är korrekta?',[
      'Opium och morfin har ursprung i opiumvallmo; heroin framställs från morfin.',
      'Spice är ett slangord för dåligt rökheroin.',
      'Opiatpåverkan kännetecknas typiskt av snabb växling mellan stark aggression och eufori.',
      'Opiatberoende utvecklas alltid långsamt och är enkelt att avgifta.',
      'Opiater/opioider kan snabbt ge beroendeutveckling.'
    ],[0,4],'Heroin är semisyntetiskt från morfin och opioider kan ge snabb beroendeutveckling.'),
    Q(29,'drogtecken','Beroende','2.1','Vilka två påståenden om centralstimulerande preparat stämmer bäst?',[
      'Amfetamin kan förekomma i läkemedel.',
      'Amfetamin ger typiskt små pupiller.',
      'Långvarigt bruk av syntetiska centralstimulantia kan ge avmagring och ryckig motorik.',
      'Amfetamin är en ren drog som aldrig ger bestående problem.',
      'Oxikodon har amfetaminliknande egenskaper.'
    ],[0,2],'Centralstimulantia kopplas till ökad aktivitet, vidgade pupiller och kan vid långvarigt bruk ge somatiska och motoriska problem.'),
    Q(30,'drogtecken','Beroende','2.1','Vilka tre preparat tillhör opiat/opioidgruppen och kan ge små pupiller?',[
      'Buprenorfin','MDMA','Morfin','LSD','Heroin','Marijuana','Kat'
    ],[0,2,4],'Buprenorfin, morfin och heroin är opioider/opiater.'),
    Q(31,'drogtecken','Beroende','2.1','Vilka tre preparat placerades i hallucinogengruppen i tentamen?',[
      'Ketamin','MDMA','Alprazolam','Kat','LSD','GHB'
    ],[0,1,4],'Tentamensfacit markerar ketamin, MDMA och LSD i denna kategorifråga.'),

    Q(32,'narkotikastraff','Narkotika','2.2','Conny uppvisar tydliga tecken på narkotikapåverkan. Vilka två åtgärder ligger närmast tentamensfacit?',[
      'Patrullen beslutar alltid själv om kroppsbesiktning vid misstänkt eget bruk.',
      'Ärendet föredras för behörig förundersökningsledare för beslut om kroppsbesiktning.',
      'När kroppsbesiktning är beslutad kan skyddsvisitation enligt PL 19 § göras inför transport i radiobil om syftet är att söka farliga föremål.',
      'Patrullen kroppsvisiterar först efter narkotika enbart för att försöka skapa skälig misstanke.'
    ],[1,2],'Tentamen skiljer beslutet om kroppsbesiktning från säkerhetsvisitation inför transport.'),
    Q(33,'narkotikastraff','Narkotika','2.2','Vilka två principer är viktiga vid misstänkt eget bruk?',[
      'Samtal och konkreta observationer kan bidra till att bygga en misstanke.',
      'Misstanke om eget bruk ger automatiskt rätt att söka igenom bostaden efter narkotika.',
      'Kroppsbesiktning kräver ett separat beslut enligt RB 28 kap.; medtagande till plats för åtgärden har egen rättslig reglering.',
      'En ficklampa eller pupillometer skapar i sig skälig misstanke utan övriga omständigheter.'
    ],[0,2],'Kursmaterialet skiljer misstankebyggande, beslut om kroppsbesiktning och medtagande. Husrannsakan för innehav kräver egen misstankegrund.'),
    Q(34,'narkotikastraff','Narkotika','1.2','Är det i sig narkotikabrott att inneha ett föremål som är utformat för narkotikabruk, exempelvis en marijuanakvarn eller haschpipa?',[
      'Sant','Falskt'
    ],1,'Tentamensfacit markerar falskt. Föremålets existens i sig är inte samma sak som innehav av narkotika.'),
    Q(35,'narkotikastraff','Narkotika','1.2','Hur bör du säkrast kontrollera om ett ämne är narkotikaklassat?',[
      'Utgå från hur preparatet marknadsförs på nätet.',
      'Kontrollera den aktuella officiella narkotikaklassningen/förteckningen som kursen hänvisar till.',
      'Utgå från att allt som står i FASS är narkotika.',
      'Anta att alla rusgivande substanser automatiskt är narkotika.'
    ],1,'Tentamen testar att narkotikaklassning måste vara formell. I skarp tillämpning ska aktuell officiell förteckning kontrolleras.'),
    Q(36,'narkotikastraff','Narkotika','1.2','En person försöker köpa narkotika för eget bruk men affären fullbordas inte. Är försöksansvar principiellt möjligt för själva förvärvsbrottet?',[
      'Nej, försök är aldrig kriminaliserat i narkotikastrafflagen.','Ja, försök till förvärv kan vara kriminaliserat även om syftet är eget bruk.'
    ],1,'Tentamen skiljer försök till förvärv från försök till själva konsumtionen/eget bruk.'),
    Q(37,'narkotikastraff','Narkotika','1.2','Vilka tre exempel på hantering av narkotika kan vara lovliga enligt tentamensmaterialet?',[
      'Privat export utan tillstånd','Vetenskapligt ändamål','Passiv förvaring åt annan','Narkotikaklassat läkemedel på recept','Samhällsnyttigt eller industriellt ändamål med rätt stöd'
    ],[1,3,4],'Lovlig hantering kräver stöd, exempelvis recept eller särskilt tillåtet vetenskapligt/industriellt ändamål.'),
    Q(38,'narkotikastraff','Narkotika','2.2','Johnny beställer 2 kg amfetamin. Polisen följer affären och stoppar transporten innan narkotikan når Johnny. Vilket alternativ ligger närmast tentamensfacit?',[
      'Johnny kan aldrig dömas eftersom han inte hann få varorna.',
      'Johnny kan endast dömas för ringa narkotikabrott.',
      'Endast transportören kan dömas.',
      'Johnny kan, beroende på bevisningen, dömas för försök till grovt narkotikabrott.'
    ],3,'Tentamensfacit markerar försök till grovt narkotikabrott i det beskrivna 2-kilosfallet.'),

    Q(39,'krisstod','Krisstöd','2.5','Vilka två påståenden om akut stress stämmer med tentamensmaterialet?',[
      'Ett akut stressyndrom blir bestående utan professionell hjälp.',
      'Stressymtom kan vara fysiska, känslomässiga och tankemässiga.',
      'Stressymtom är enbart kroppsliga reaktioner.',
      'Efter en potentiellt traumatisk händelse avklingar akuta stressreaktioner ofta inom timmar eller dagar.'
    ],[1,3],'Tentamen normaliserar flera typer av stressreaktioner och betonar att många akuta reaktioner avtar.'),
    Q(40,'krisstod','Krisstöd','3.1','Är det en central uppgift i kamratstöd att pressa den drabbade att beskriva sina känslor så ingående som möjligt?',[
      'Sant','Falskt'
    ],1,'Modernt krisstöd fokuserar på säkerhet, lugn, stöd och individuella behov – inte på framtvingad detaljerad emotionell bearbetning.'),
    Q(41,'krisstod','Krisstöd','2.5','Vilka fem komponenter ingår i Hobfolls fem principer så som de återges i tentamen?',[
      'Stärka hopp','Stärka tillit/egen förmåga','Understödja samhörighet','Detaljerat återberätta händelsen','Lugna och stabilisera','Stärka säkerhet och trygghet'
    ],[0,1,2,4,5],'Tentamen testar trygghet, lugn, tillit/efficacy, samhörighet och hopp.'),

    Q(42,'kommunikation','Kommunikation','3.2','Vilka två påståenden beskriver vardagsförhandling bäst enligt tentamen?',[
      'Endast särskilt utbildade förhandlare får påbörja vardagsförhandling.',
      'Vardagsförhandling är ett verktyg som poliser kan använda i många olika situationer.',
      'Den som börjar förhandla måste alltid ensam fullfölja situationen.',
      'Aktivt lyssnande är en grund i vardagsförhandling.',
      'Metoden används enbart vid suicidförsök.',
      'Vardagsförhandling är alltid den bästa lösningen i en hotfull situation.'
    ],[1,3],'Tentamen lyfter vardagsförhandling som ett brett verktyg och aktivt lyssnande som grund.'),
    Q(43,'kommunikation','Kommunikation','3.2','Vilka tre påståenden beskriver samtalstekniker i aktivt lyssnande?',[
      'Jag-budskap kan utgå från den egna upplevelsen, exempelvis ”Jag upplever att du är upprörd”.',
      'Parafrasering betyder bara att omedelbart fråga ”varför?”.',
      'Övertygande argumentation är själva kärnan i aktivt lyssnande.',
      'Kroppsspråk saknar betydelse i aktivt lyssnande.',
      'Parafrasering kan återge det man uppfattat och följas av en öppen fråga.',
      'Visa närvaro kan innebära aktivt kroppsspråk och ögonkontakt när det är lämpligt.'
    ],[0,4,5],'Aktivt lyssnande omfattar hur du formulerar dig, återger förståelse och visar närvaro – inte bara de talade orden.'),
    Q(44,'kommunikation','Kommunikation','3.2','Vilka fyra tekniker kan typiskt ingå i aktivt lyssnande?',[
      'Effektiva pauser','Tydliggöra rättsläget','Parafrasera','Övertyga','Identifiera känslor','Visa närvaro'
    ],[0,2,4,5],'Tentamensfacit markerar effektiva pauser, parafrasering, identifiering av känslor och närvaro.')
  ];

  // Gör tentamensfrågorna till en del av den ordinarie frågebanken och modultesterna.
  D.quiz.push(...D.examInspired);
  D.examInspired.forEach(q => {
    const lesson = D.moduleLessons?.[q.moduleId];
    if (!lesson) return;
    lesson.testQuestions = lesson.testQuestions || [];
    lesson.testQuestions.push({...q});
    lesson.examInspiredCount = (lesson.examInspiredCount || 0) + 1;
  });

  D.drugProfiles = [
    {id:'opioid',label:'Opiater/opioider',pupil:0.22,pulse:'långsam/normal',breath:'långsam – viktig risksignal',speech:'lågmält/sluddrigt',motor:'sömnig, ihopsjunken',eyes:'hängande ögonlock',mind:'välbefinnande, likgiltighet eller dåsighet',examples:'heroin, morfin, buprenorfin',source:'Drogtecken  Symptom.pdf'},
    {id:'stimulant',label:'Centralstimulerande',pupil:0.76,pulse:'hastig/ibland oregelbunden',breath:'ofta snabbare',speech:'pratsamt, snabbt',motor:'rastlös, spänd, ryckig',eyes:'vidgade pupiller/fixerad blick',mind:'energi, självförtroende, retlighet, tankeflykt',examples:'amfetamin, metamfetamin, kokain',source:'Drogtecken  Symptom.pdf'},
    {id:'cannabis',label:'Cannabis',pupil:0.62,pulse:'ofta hastig',breath:'vanligen inte huvudsymtomet',speech:'kan tappa tanketråden',motor:'kan vara avslappnad eller påverkad i koordination',eyes:'rödsprängda/glansiga ögon',mind:'fnittrighet, tids-/rumsstörning, förvirring/paranoia',examples:'marijuana, hasch',source:'Drogtecken  Symptom.pdf'},
    {id:'benzo',label:'Bensodiazepiner / centraldepressiva',pupil:0.45,pulse:'varierande',breath:'ytlig vid hög dos',speech:'sluddrigt/stammande',motor:'långsamma reflexer, slapp muskulatur',eyes:'normal pupillstorlek, långsam ljusreaktion',mind:'dåsighet, hämningslöshet, stämningssvängning',examples:'diazepam, alprazolam',source:'Drogtecken  Symptom.pdf'},
    {id:'hallucinogen',label:'Hallucinogener',pupil:0.73,pulse:'kan vara ökad',breath:'varierande',speech:'kan bli osammanhängande',motor:'koordination kan påverkas',eyes:'ofta stora pupiller',mind:'förvanskad verklighetsbild, hallucinationer, humörsvängningar',examples:'LSD, MDMA/ketamin i tentamenskategorin',source:'Drogtecken  Symptom.pdf'},
    {id:'alcohol',label:'Alkohol / centraldepressiv påverkan',pupil:0.45,pulse:'varierande',breath:'kan påverkas vid hög dos',speech:'sluddrigt',motor:'ostadigt, långsamma reflexer',eyes:'ofta utan specifikt pupillmönster',mind:'sänkta hämningar, omdömespåverkan',examples:'alkohol',source:'Beroendeproblematik + Drogtecken'}
  ];

  D.adaptiveScenarios = [
    {
      id:'bridge-lpt',title:'Bron – akut suicidrisk',area:'LPT · risk · kommunikation',start:'s1',source:'LPT - distans.pdf + Tentamen D2PM2U 2025',
      nodes:{
        s1:{text:'Lisa står på utsidan av räcket på en hög bro. Hon säger att hon tänker hoppa. Det finns skälig anledning att anta APS och fara för eget liv.',q:'Vad prioriterar du först?',choices:[
          {t:'Invänta vårdintyg innan du agerar.',score:-2,why:'Vårdintyg behöver inte föregå polisens akuta omhändertagande enligt LPT 47/PL 11 i den beskrivna situationen.',next:'s2'},
          {t:'Säkra omedelbar livsfara, skapa kontakt och klarlägg akut rättsgrund parallellt.',score:2,why:'Säkerhet, kommunikation och rättsgrund måste hanteras samtidigt.',next:'s2'},
          {t:'Börja med ett långt förhör om bakgrunden.',score:-1,why:'Akut livsfara måste först stabiliseras.',next:'s2'}]},
        s2:{text:'Lisa vägrar följa med. Situationen kan inte vänta på ett myndighetsbeslut utan att livsfaran kvarstår.',q:'Vilken juridisk tanke är mest relevant?',choices:[
          {t:'PL 11 § kan aktualiseras vid fara i dröjsmål i avvaktan på Polismyndighetens beslut.',score:2,why:'Det är den lösning som kursmaterialet beskriver.',next:'s3'},
          {t:'LOB är alltid rätt eftersom Lisa är upprörd.',score:-2,why:'Upprördhet i sig gör inte LOB till rättsgrund.',next:'s3'},
          {t:'Ingen polisiär åtgärd är möjlig förrän ambulans kommer.',score:-2,why:'Kursmaterialet ger en akut polisiär väg.',next:'s3'}]},
        s3:{text:'Du har fått fysisk säkerhet och Lisa är i kontakt med dig.',q:'Vilken kommunikation ligger närmast kursens principer?',choices:[
          {t:'Bekräfta upplevelsen, lyssna aktivt och ge korta tydliga budskap.',score:2,why:'Aktivt lyssnande och trygghet bygger mottaglighet.',end:true},
          {t:'Förklara omedelbart varför hennes känslor är orimliga.',score:-1,why:'Argumentation om upplevelsen riskerar att försämra kontakt.',end:true},
          {t:'Ställ många detaljerade frågor i snabb följd.',score:-1,why:'I akut känsloläge är det bättre med lugnt tempo och tydlighet.',end:true}]}
      }
    },
    {
      id:'brita-handrack',title:'Brita – vårdintyg och handräckning',area:'Handräckning · LPT',start:'s1',source:'Handräckning - distans.pdf + Tentamen D2PM2U 2025',
      nodes:{
        s1:{text:'Ni har ett beviljat handräckningsuppdrag för att möjliggöra vårdintygsundersökning. Brita motsätter sig att följa med.',q:'Vilken princip styr uppdraget?',choices:[
          {t:'Formell handräckning med särskilt lagstöd; använd bara nödvändiga befogenheter.',score:2,why:'Handräckning kräver särskilt lagstöd och är inte ett allmänt transportuppdrag.',next:'s2'},
          {t:'Det räcker att anhörig vill att Brita körs till sjukhus.',score:-2,why:'En behörig formell begäran krävs.',next:'s2'},
          {t:'Handräckning är alltid samma sak som omhändertagande enligt 47 § första stycket.',score:-1,why:'Eget akut omhändertagande och handräckning är olika rättsliga spår.',next:'s2'}]},
        s2:{text:'På vårdavdelningen säger personalen att läkaren dröjer och att Brita kan bli våldsam.',q:'När är uppdraget färdigt enligt tentamensfacit?',choices:[
          {t:'Så fort Brita har passerat avdelningens dörr.',score:-2,why:'Tentamensfacit bedömer att handräckningen avser att möjliggöra själva undersökningen.',end:true},
          {t:'När läkaren har kunnat genomföra den vårdintygsundersökning som uppdraget avser.',score:2,why:'Detta är det korrekta alternativet i den uppladdade tentamen.',end:true},
          {t:'När patrullen bedömer att Brita verkar lugn.',score:-1,why:'Samarbetsvilja ändrar inte automatiskt ett pågående formellt uppdrag.',end:true}]}
      }
    },
    {
      id:'conny-nark',title:'Conny – misstänkt eget bruk',area:'Narkotika · tvångsmedel',start:'s1',source:'Narkotikastrafflagen + Tentamen D2PM2U 2025',
      nodes:{
        s1:{text:'Conny har rödsprängda ögon, är slö och nervös. Ni misstänker narkotikabruk.',q:'Vad gör du med misstanken?',choices:[
          {t:'Dokumentera observationer, samtala och bygg en konkret misstankegrund.',score:2,why:'Enskilda tecken ska sättas i ett sammanhang.',next:'s2'},
          {t:'Gör husrannsakan i bostaden direkt eftersom eget bruk alltid innebär innehav.',score:-2,why:'Misstanke om eget bruk ger inte automatiskt misstanke om innehav i bostaden.',next:'s2'},
          {t:'Utgå från att rödsprängda ögon ensamt räcker för alla tvångsmedel.',score:-1,why:'Varje tvångsmedel kräver egen rättslig grund.',next:'s2'}]},
        s2:{text:'Misstankegraden för eget bruk bedöms vara skälig.',q:'Vilket nästa steg är kursenligt för urin/blodprov?',choices:[
          {t:'Föredra ärendet för behörig förundersökningsledare för beslut om kroppsbesiktning.',score:2,why:'Kursens svarsmaterial anger RB 28:12 och FUL för kroppsbesiktningen.',next:'s3'},
          {t:'Patrullen kan alltid själv besluta om kroppsbesiktningen.',score:-2,why:'Tentamen markerar detta som fel.',next:'s3'},
          {t:'Ta prov utan beslut eftersom Conny är känd av polisen.',score:-2,why:'Känd person ersätter inte lagstöd.',next:'s3'}]},
        s3:{text:'Beslut om kroppsbesiktning är fattat och Conny ska transporteras i radiobil.',q:'Vilken visitation kan vara relevant före transport?',choices:[
          {t:'Skyddsvisitation enligt PL 19 § för att söka farliga föremål.',score:2,why:'Detta var ett korrekt alternativ i tentamen.',end:true},
          {t:'Kroppsvisitation efter narkotika enbart för att ”stärka” misstanken.',score:-1,why:'Tvångsmedel ska inte användas för att skapa den misstanke som krävs för dem.',end:true},
          {t:'Ingen säkerhetsvisitation får någonsin göras före transport.',score:-1,why:'PL 19 kan ge stöd för skyddsvisitation i rätt situation.',end:true}]}
      }
    },
    {
      id:'lvm-resurs',title:'Krister – LVM-handräckning och resursfrågan',area:'LVM · handräckning',start:'s1',source:'Handräckning - distans.pdf + Tentamen D2PM2U 2025',
      nodes:{
        s1:{text:'Socialnämnden har beslutat om omedelbart LVM-omhändertagande och begär hjälp enligt 45 §. Krister är känd som lugn.',q:'Hur ska handräckningsbehovet förstås?',choices:[
          {t:'Handräckning ska inte ske slentrianmässigt; lagen begränsar när polisens hjälp får begäras.',score:2,why:'Behov av särskilda polisiära befogenheter eller synnerliga skäl ska finnas.',next:'s2'},
          {t:'Polisen ska alltid användas som transportresurs i alla LVM-fall.',score:-1,why:'Materialet säger uttryckligen att polis inte ska utföra transporter rutinmässigt.',next:'s2'},
          {t:'Om Krister brukar vara lugn är ett redan beviljat uppdrag automatiskt ogiltigt.',score:-1,why:'Patrullen ska verkställa ett lagligen grundat uppdrag och kan inte själv upphäva det.',next:'s2'}]},
        s2:{text:'Patrullen vill hellre arbeta synligt i ett utsatt område och hänvisar till resursbrist.',q:'Vilket påstående överensstämmer med tentamen?',choices:[
          {t:'Polismyndigheten kan neka en behörig handräckning enbart på grund av resursbrist.',score:-2,why:'Det alternativet markeras fel i tentamen.',end:true},
          {t:'Polismyndigheten kan inte neka den behöriga handräckningen enbart med hänvisning till resursbrist.',score:2,why:'Detta är ett korrekt tentamensalternativ.',end:true},
          {t:'Patrullen kan avbryta så fort Krister är på gott humör.',score:-1,why:'Samarbetsvilja innebär inte automatiskt att uppdraget upphör.',end:true}]}
      }
    }
  ];
})();

// V6: två ytterligare tentamensnära frågor för LVM och LRV.
(() => {
  const D=window.STUDY_DATA, src='Tentamen D2PM2U 2025 (omarbetad)';
  const extra=[
    {examNo:6,moduleId:'lvm',topic:'LVM',goal:'1.2',origin:'exam2025',source:src,q:'Vilket påstående fångar LVM:s grundkaraktär bäst?',a:['Vård enligt LVM kräver alltid den enskildes samtycke.','LVM är en tvångslagstiftning; när vård beslutats kan den enskilde inte själv välja bort LVM-vården på samma sätt som en frivillig SoL-insats.','Polismyndigheten beslutar vem som ska dömas till LVM.','Hälso- och sjukvården utfärdar själv ett LVM-beslut.'],c:1,e:'LVM är vård oberoende av samtycke när lagens rekvisit och beslutsordning är uppfyllda. Polis och hälso- och sjukvård har andra roller i processen.'},
    {examNo:15,moduleId:'lrv',topic:'LRV',goal:'1.2',origin:'exam2025',source:src,q:'Vilket påstående återgavs som korrekt i tentamen 2025 om rättspsykiatrin?',a:['Psykossjukdom förekommer inte inom LRV.','Tentamen angav att personer med psykossjukdom utgjorde omkring 45 procent av de som vårdades enligt LRV.','Alla som vårdas enligt LRV saknar psykotiska symtom.','LRV används enbart vid missbruk utan psykisk störning.'],c:1,e:'Detta är en daterad tentamensuppgift från 2025 och ska läsas som tentamensinspiration, inte som en aktuell officiell statistikuppgift.'}
  ];
  D.examInspired.push(...extra);D.quiz.push(...extra);extra.forEach(q=>{const l=D.moduleLessons[q.moduleId];if(l){l.testQuestions=l.testQuestions||[];l.testQuestions.push({...q});l.examInspiredCount=(l.examInspiredCount||0)+1;}});
})();

(() => {
  const D=window.STUDY_DATA;
  const examSource='Tentamen D2PM2U 2025 – inspirationskälla (uppladdad PDF)';
  D.sources=D.sources||[];
  if(!D.sources.includes(examSource)) D.sources.push(examSource);
})();
